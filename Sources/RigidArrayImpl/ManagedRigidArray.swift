...
@safe
@usableFromInline
package struct ManagedRigidArray<Element: ~Copyable>: ~Copyable {
  @usableFromInline
  package var _storage: UnsafeMutableBufferPointer<Element>
...
@available(SwiftStdlib 5.1, *)
extension ManagedRigidArray: @unchecked Sendable where Element: Sendable & ~Copyable {}

@available(SwiftStdlib 5.1, *)
extension ManagedRigidArray where Element: ~Copyable {
...
extension ManagedRigidArray where Element: ~Copyable {
  @_alwaysEmitIntoClient
  package var _items: UnsafeMutableBufferPointer<Element> {
    unsafe _storage.extracting(Range(uncheckedBounds: (0, _count)))
  }

  @_alwaysEmitIntoClient
  package var _freeSpace: UnsafeMutableBufferPointer<Element> {
...
extension ManagedRigidArray where Element: ~Copyable {
  ...
  @_alwaysEmitIntoClient
  @_transparent
  package var mutableSpan: MutableSpan<Element> {
    @_lifetime(&self)
    mutating get {
  ...
  @_alwaysEmitIntoClient
  @_lifetime(borrow self)
  package func _span(in range: Range<Int>) -> Span<Element> {
    span.extracting(range)
  }

  @_alwaysEmitIntoClient
  @_lifetime(&self)
  package mutating func _mutableSpan(
    in range: Range<Int>
  ) -> MutableSpan<Element> {
...
extension ManagedRigidArray where Element: ~Copyable {
  ...
  @available(SwiftStdlib 5.1, *)
  @_alwaysEmitIntoClient
  package mutating func edit<E: Error, R: ~Copyable>(
  ...
  @unsafe
  @_alwaysEmitIntoClient
  package mutating func _unsafeEdit<E: Error, R: ~Copyable>(
...
extension ManagedRigidArray where Element: ~Copyable {
  @_alwaysEmitIntoClient
  package func _contiguousSubrange(following index: inout Int) -> Range<Int> {
  ...
  @_alwaysEmitIntoClient
  package func _contiguousSubrange(preceding index: inout Int) -> Range<Int> {
    precondition(index >= 0 && index <= _count, "Index out of bounds")
    defer { index = 0 }
...
extension ManagedRigidArray where Element: ~Copyable {
  ...
  @available(SwiftStdlib 5.1, *)
  @_alwaysEmitIntoClient
  package mutating func setCapacity(_ newCapacity: Int) {
...
extension ManagedRigidArray {
  ...
  @available(SwiftStdlib 5.1, *)
  @_alwaysEmitIntoClient
  package func clone(capacity: Int) -> Self {
...
extension ManagedRigidArray where Element: ~Copyable {
  @_alwaysEmitIntoClient
  package mutating func _closeGap(
  ...
  @unsafe
  @_alwaysEmitIntoClient
  package mutating func _openGap(
    at index: Int, count: Int
  ...
  @unsafe
  @_alwaysEmitIntoClient
  package mutating func _resizeGap(
