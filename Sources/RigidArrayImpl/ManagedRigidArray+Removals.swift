...
extension ManagedRigidArray where Element: ~Copyable {
  ...
  @available(SwiftStdlib 5.1, *)
  @_alwaysEmitIntoClient
  package mutating func removeLast(_ k: Int) {
    if k == 0 { return }
    precondition(
      k >= 0 && k <= _count,
  ...
  @available(SwiftStdlib 5.1, *)
  @_alwaysEmitIntoClient
  package mutating func removeSubrange(_  bounds: Range<Int>) {
  ...
  @available(SwiftStdlib 5.1, *)
  @_alwaysEmitIntoClient
  package mutating func removeSubrange(_  bounds: some RangeExpression<Int>) {
