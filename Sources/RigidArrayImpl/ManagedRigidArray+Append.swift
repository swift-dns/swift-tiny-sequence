...
extension ManagedRigidArray where Element: ~Copyable {
  ...
  package mutating func append(_ item: consuming Element) {
  ...
  @available(SwiftStdlib 5.1, *)
  @_alwaysEmitIntoClient
  package mutating func pushLast(_ item: consuming Element) -> Element? {
...
extension ManagedRigidArray where Element: ~Copyable {
  ...
  @available(SwiftStdlib 5.1, *)
  @_alwaysEmitIntoClient
  package mutating func append<E: Error>(
...
extension ManagedRigidArray {
  ...
  @available(SwiftStdlib 5.1, *)
  @_alwaysEmitIntoClient
  package mutating func append(copying items: Span<Element>) {
  ...
  @_alwaysEmitIntoClient
  @_transparent
  package mutating func _append<S: Sequence<Element>>(
    prefixOf items: S
  ) -> S.Iterator {
  ...
  @available(SwiftStdlib 5.1, *)
  @_alwaysEmitIntoClient
  package mutating func append(copying newElements: some Sequence<Element>) {
