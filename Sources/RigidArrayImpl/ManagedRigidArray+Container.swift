...
extension ManagedRigidArray where Element: ~Copyable {
  ...
  @available(SwiftStdlib 5.1, *)
  @_alwaysEmitIntoClient
  package mutating func swapAt(_ i: Int, _ j: Int) {
    _checkItemIndex(i)
    _checkItemIndex(j)
...
extension ManagedRigidArray where Element: ~Copyable {
  ...
  @_alwaysEmitIntoClient
  @_transparent
  package func index(before index: Int) -> Int {
    index - 1
  }
  ...
  @_alwaysEmitIntoClient
  @_transparent
  package func formIndex(after index: inout Int) {
    index += 1
  }
  ...
  @_alwaysEmitIntoClient
  @_transparent
  package func formIndex(before index: inout Int) {
    index -= 1
  }
  ...
  @_alwaysEmitIntoClient
  @_transparent
  package func index(_ index: Int, offsetBy n: Int) -> Int {
    index + n
  }
